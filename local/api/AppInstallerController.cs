...
public class AppInstallerController : Custom.Hybrid.Api14
{
    [HttpGet]        // [HttpGet] says we're listening to GET requests
    public dynamic GetAutoInstallerApps(string ModuleId, string SexyContentVersion, string Platform, string SysVersion, string SxcVersion)
    {
...
//   var appSimple = dynCodeSvc.App(12);

  var allInstalls = AsList(App.Query["AutoInstaller"]);
